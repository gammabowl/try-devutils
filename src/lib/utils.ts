...
export const utils: Util[] = [
  ...
  { id: "sql", label: "SQL Formatter", icon: Database, component: LazySqlFormatter, description: "Format SQL for PostgreSQL, MySQL, MariaDB, PL/SQL", color: "from-purple-500 to-purple-600", textColor: "text-purple-600", bgColor: "bg-purple-500/10" },
  { id: "ssl", label: "SSL Certificate Decoder", icon: ShieldCheck, component: LazySslCertificateDecoder, description: "Decode and inspect X.509 certificates", color: "from-green-500 to-green-600", textColor: "text-green-600", bgColor: "bg-green-500/10" },
  { id: "string", label: "String Analyser", icon: Type, component: LazyStringAnalyser, description: "Analyse text stats and convert case", color: "from-violet-500 to-violet-600", textColor: "text-violet-600", bgColor: "bg-violet-500/10" },
  ...
  { id: "timestamp", label: "Timestamp/Date Converter", icon: Clock, component: LazyTimestampConverter, description: "Convert Unix timestamps to dates", color: "from-teal-500 to-teal-600", textColor: "text-teal-600", bgColor: "bg-teal-500/10" },
