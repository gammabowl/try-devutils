...
export const utils: Util[] = [
  ...
  { id: "uuid", label: "UUID Generator/Decoder", icon: FingerprintIcon, component: LazyUuidGeneratorDecoder, description: "Generate, validate, decode UUIDs", color: "from-cyan-500 to-cyan-600", textColor: "text-cyan-600", bgColor: "bg-cyan-500/10", category: "Generators" },
  ...
  { id: "keypair", label: "Key Pair Generator", icon: Key, component: LazyKeyPairGenerator, description: "Generate RSA/ECDSA key pairs for SSL & SSH", color: "from-red-800 to-red-900", textColor: "text-red-800", bgColor: "bg-red-800/10", category: "Generators" },
  { id: "timestamp", label: "Timestamp/Date Converter", icon: Clock, component: LazyTimestampConverter, description: "Convert Unix timestamps to dates", color: "from-teal-500 to-teal-600", textColor: "text-teal-600", bgColor: "bg-teal-500/10", category: "Generators" },
